...
REM
REM Generated by Vivado on Mon Nov 10 19:08:09 -0600 2025
...
echo "xvlog --incr --relax -prj tb_three_bit_binary_adder_vlog.prj"
call xvlog  --incr --relax -prj tb_three_bit_binary_adder_vlog.prj -log xvlog.log
